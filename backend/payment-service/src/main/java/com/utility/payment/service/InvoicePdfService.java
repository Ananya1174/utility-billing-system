    ...
    public byte[] generateInvoicePdf(String paymentId) {
        ...
        try {
            ...
            PdfPCell totalLabel = new PdfPCell(
                    new Phrase("Total Amount", boldFont));
            totalLabel.setPadding(8);

            PdfPCell totalValue = new PdfPCell(
                    new Phrase(String.format("₹ %.2f", invoice.getTotalAmount()), boldFont));
